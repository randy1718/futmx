...
$dato= filter_input(INPUT_POST, "nombreNuevo");

$sql = "update equipos set NombreEquipo='$dato' where idEquipo='$id'";
$sql1 = "delete from solicitudesactualizacionequipo where idEquipo='$id'";
