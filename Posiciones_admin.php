...
<div class="rectangulo">
    ...
    <a class="ingreso" href="inter_admin_liga.php" name="Opcion" value="1" style="color:#000000"> Atrás</a>
</div>
...
<div class="d1">
    <div class="contenedor_posiciones">
        ...
        <table class="table_posiciones">
            ...
            $partidos="select count(*) as numero from partido inner join liga on Liga=idLiga inner join usuario on Administrador=documento_identidad where NombreUsuario='$usuar'";
            ...
            $ejecutar1 = mysqli_query($conexion, $partidos) or die("problems:" . mysqli_error($conexion));
            $rows1 = mysqli_fetch_array($ejecutar1);
            $numPartidos=$rows1['numero'];
            $clasifica = "class='td2'";
